...
if ($enable){
    ...
    register_shutdown_function(function () {
            ...
            if ($id) {
                //echo "<a style=\"position:absolute;right:20px; bottom:10px;\" class=\"btn btn btn-mini\" href=\"/dev/xhprof_html/index.php?run={$id}&source=sunday\" target=\"_blank\">PROFILE</a>\n";
            }
        });
}