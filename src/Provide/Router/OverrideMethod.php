...
final class OverrideMethod
{
    ...
    public function get(array $server, array $get, array $post) {
        ...
        return [$this->method, $this->getParams($this->method, $get, $post)];
    }
     ...
     * @return array
     */
    private function getParams($method, array $get, array $post)
    {
    ...
    /**
     * Return 'php://input' query
     *
     * @return array
     */
    private function phpInput()
    {
        $input = file_get_contents('php://input');
        $input ?  parse_str(file_get_contents('php://input'), $put) : $put = [];
