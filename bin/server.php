...
$router = dirname(__DIR__) . "/apps/{$appDir}/bootstrap/contexts/{$context}.php";
if (! file_exists($router)) {
    $router = dirname(__DIR__) . "/apps/{$appDir}/var/www/index.php";
}

if (! file_exists(dirname(__DIR__) . "/apps/{$appDir}/var/www")) {
    error();
}
...
$root =  dirname(__DIR__) . "/apps/{$appDir}/var/www/";
