...
use BEAR\Resource\ResourceObject;class MyVendor_MyApp_Resource_Page_User_F5NHMBA extends MyVendor\MyApp\Resource\Page\User implements Ray\Aop\WeavedInterface
{
     ...
     * {@inheritdoc}
     */
    public function transfer(BEAR\Resource\TransferInterface $responder)
    {
        if (isset($this->bindings[__FUNCTION__]) === false) {
            return call_user_func_array('parent::' . __FUNCTION__, func_get_args());
        }
